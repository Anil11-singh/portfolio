    ...
    <div className="min-h-screen bg-slate-950 text-white antialiased">
      ...
      >
        <div className="max-w-6xl mx-auto px-6 py-5 flex items-center justify-between">
          ...
          {/* Right */}
          <div className="flex items-center gap-6 bg-gray-50 bg-gradient-to-r from-blue-300 to-purple-300 text-slate-900 px-6 py-4 shadow">
      ...
      <main className="max-w-6xl mx-auto px-6 py-10">
        ...
        <section id="experience" className="py-15">
          ...
          <h6 className="text-xl text-left mb-0 text-gray-400">
        ...
        <section id="contact" className="mt-4">
          <div className="min-h-screen bg-gradient-to-br from-slate-900 to-blue flex items-center justify-center px-0">
            <div className="w-full">
              {/* Header */}
              <div className="mb-6">
                <h1 className="text-2xl text-left mb-0 font-bold text-white">
                  Contact
                </h1>
              ...
              <div className="grid grid-cols-1 mb-28 md:grid-cols-3 gap-6">
                ...
                <div className="md:col-span-2 rounded-2xl border border-white/10 bg-gradient-to-br from-slate-900 to-slate-950 p-6 shadow-xl">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    <div>
                      ...
                      <input
                        ...
                        className="mt-1 w-full rounded-xl bg-white/5 border border-white/10 px-4 py-2 text-white text-left placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-indigo-500"
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="mt-1 w-full rounded-xl bg-white/5 border border-white/10 px-4 py-2 text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-indigo-500"
                      />
                    </div>
                  </div>
                  ...
                  <div className="mb-6">
                    ...
                    <textarea
                      ...
                      rows={5}
                      className="mt-1 w-full rounded-xl bg-white/5 border border-white/10 px-4 py-3 text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-indigo-500"
                    />
                  </div>

                  <button
                    type="button"
                    className="w-full rounded-xl bg-gradient-to-r from-blue-500 to-purple-500 py-3 text-white font-medium hover:opacity-90 transition"
                  >
                    Send Message
                  </button>
                </div>
                ...
                <div className="rounded-2xl border border-white/10 bg-gradient-to-b from-slate-900 to-slate-950 p-8 shadow-xl">
                  ...
                  <div className="flex gap-3 flex-wrap">
                    ...
                    <a
                      href="https://www.linkedin.com/in/anil-kumar-mahato-8bbb9924a"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="px-4 py-2 rounded-xl border border-white/20 text-white hover:bg-white/10 transition"
                    >
